...
#line 152 "/root/.cargo/registry/src/index.crates.io-1949cf8c6b5b557f/cpp_build-0.5.11/src/lib.rs"

extern "C" {
    void (*rust_cpp_callbacks1002887767523466483[6])() = {};
}
...
#line 1171 "src/qtdeclarative.rs"
...
#line 1187 "src/qtdeclarative.rs"
...
#line 228 "/root/.cargo/registry/src/index.crates.io-1949cf8c6b5b557f/cpp_build-0.5.11/src/lib.rs"
...
#line 247 "/root/.cargo/registry/src/index.crates.io-1949cf8c6b5b557f/cpp_build-0.5.11/src/lib.rs"
...
#line 136 "src/itemmodel.rs"
            ...
            for (QModelIndex &idx : list2) {
                reinterpret_cast<void (*)(rustcpp::argument_helper<TraitObject>::type, rustcpp::argument_helper<QModelIndex &>::type)>(rust_cpp_callbacks1002887767523466483[0])(f, idx)
...
extern "C" {
void __cpp_closure_11039484640512489565(Rust_QAbstractListModel* const& obj, QModelIndex const& source_parent, int const& source_first, int const& source_last, QModelIndex const& destination_parent, int const& destination_child) {
#line 122 "src/listmodel.rs"
...
extern "C" {
void __cpp_closure_1340008222591477288(Rust_QAbstractListModel* const& obj) {
...
static inline QVariant __cpp_closure_14041139341725836627_impl(QmlEngineHolder * const& self, QByteArray const& name, size_t const& args_size, QVariant * const& args_ptr) {
#line 210 "src/qtdeclarative.rs"
...
extern "C" {
void __cpp_closure_14041139341725836627(QmlEngineHolder * const& self, QByteArray const& name, size_t const& args_size, QVariant * const& args_ptr, void* __result) {
    ::new(__result) (QVariant)(__cpp_closure_14041139341725836627_impl(self, name, args_size, args_ptr));
}
}
#line 228 "/root/.cargo/registry/src/index.crates.io-1949cf8c6b5b557f/cpp_build-0.5.11/src/lib.rs"

extern "C" {
void __cpp_closure_16792237966274974184(QmlEngineHolder * const& self, QByteArray const& name, size_t const& args_size, QVariant * const& args_ptr) {
#line 246 "src/qtdeclarative.rs"
...
extern "C" {
void __cpp_closure_7874822675106506785(QmlEngineHolder * const& self) {
#line 270 "src/qtdeclarative.rs"
...
extern "C" {
void __cpp_closure_12124250206923320362(QmlEngineHolder * const& self) {
#line 276 "src/qtdeclarative.rs"
...
#line 1004 "src/qtdeclarative.rs"
...
#line 1010 "src/qtdeclarative.rs"
...
#line 1016 "src/qtdeclarative.rs"
...
#line 1026 "src/qtdeclarative.rs"
...
#line 1040 "src/qtdeclarative.rs"
...
#line 1048 "src/qtdeclarative.rs"
...
#line 1056 "src/qtdeclarative.rs"
...
#line 1064 "src/qtdeclarative.rs"
...
#line 1072 "src/qtdeclarative.rs"
...
#line 1080 "src/qtdeclarative.rs"
...
#line 1161 "src/qtdeclarative.rs"
...
#line 1263 "src/qtdeclarative.rs"
...
#line 163 "src/scenegraph.rs"
                ...
                if (raw->size != len || raw->type_id != type_id) {
                    reinterpret_cast<void (*)()>(rust_cpp_callbacks1002887767523466483[1])();
                }
                return raw->mask;
...
#line 224 "src/scenegraph.rs"
                ...
                if (raw->size != std::size_t(-1) || raw->type_id != type_id) {
                    reinterpret_cast<void (*)()>(rust_cpp_callbacks1002887767523466483[2])();
                }
                return raw->mask;
...
#line 255 "src/scenegraph.rs"
                ...
                if (!node) reinterpret_cast<void (*)()>(rust_cpp_callbacks1002887767523466483[3])();
...
#line 265 "src/scenegraph.rs"
                ...
                if (!node->parent()) {
                    ...
                    reinterpret_cast<void (*)()>(rust_cpp_callbacks1002887767523466483[4])();
                }
...
#line 443 "src/scenegraph.rs"
                                                             
            if (!node->parent()) {
                raw->prependChildNode(node);
            } else if (node->parent() != raw) {
                reinterpret_cast<void (*)()>(rust_cpp_callbacks1002887767523466483[5])();
            }
            node->setFlag(QSGNode::OwnedByParent);
...
#line 308 "/root/.cargo/registry/src/index.crates.io-1949cf8c6b5b557f/cpp_build-0.5.11/src/lib.rs"
...
MetaData metadata_1002887767523466483 = {
    ...
    { {8780417384711100581ull, 0, 1, 0ull << 32}, {
                ...
                rustcpp::AlignOf<Rust_QAbstractListModel*>::value,
                rustcpp::Flags<Rust_QAbstractListModel*>::value
            }, {11039484640512489565ull, 0, 1, 1ull << 32}, {
                11039484640512489565ull,
                sizeof(Rust_QAbstractListModel*),
                rustcpp::AlignOf<Rust_QAbstractListModel*>::value,
                rustcpp::Flags<Rust_QAbstractListModel*>::value
            }, {
                ...
                rustcpp::AlignOf<int>::value,
                rustcpp::Flags<int>::value
            }, {1340008222591477288ull, 0, 1, 1ull << 32}, {
                1340008222591477288ull,
                sizeof(Rust_QAbstractListModel*),
                rustcpp::AlignOf<Rust_QAbstractListModel*>::value,
                rustcpp::Flags<Rust_QAbstractListModel*>::value
                ...
                rustcpp::AlignOf<QVariant *>::value,
                rustcpp::Flags<QVariant *>::value
            }, {16792237966274974184ull, 0, 1, 1ull << 32}, {
                16792237966274974184ull,
                sizeof(QmlEngineHolder *),
                rustcpp::AlignOf<QmlEngineHolder *>::value,
                rustcpp::Flags<QmlEngineHolder *>::value
            }, {
                ...
                rustcpp::AlignOf<QVariant *>::value,
                rustcpp::Flags<QVariant *>::value
            }, {7874822675106506785ull, 0, 1, 1ull << 32}, {
                7874822675106506785ull,
                sizeof(QmlEngineHolder *),
                rustcpp::AlignOf<QmlEngineHolder *>::value,
                rustcpp::Flags<QmlEngineHolder *>::value
            }, {12124250206923320362ull, 0, 1, 1ull << 32}, {
                12124250206923320362ull,
                sizeof(QmlEngineHolder *),
                rustcpp::AlignOf<QmlEngineHolder *>::value,
                rustcpp::Flags<QmlEngineHolder *>::value
            }, {
