...
ApplicationWindow {
    ...
    width: 1280
    height: 800
    title: "git-review · qmetaobject"
    color: cBg

    // ---- theme: both GitHub palettes, switched on the desktop scheme ----
    // Qt 6.4's QML has no Qt.styleHints.colorScheme (added 6.5); the Rust backend detects the
    // scheme and exposes `backend.dark` (headless defaults to light).
    ...
    readonly property color cBtnBg:   dark ? "#21262d" : "#eaeef2"
    ...
    // ===== ROOT: full-width toolbar on top, then the resizable split below =====
    ColumnLayout {
        anchors.fill: parent
        spacing: 0

        // ---- TOOLBAR (full width, pinned at the very top, above side + main) ----
        Rectangle {
            ...
            RowLayout {
                ...
                Text { text: "+" + backend.totalAdded; color: cAddFg; font.pixelSize: 13; font.bold: true }
                Text { text: "−" + backend.totalRemoved; color: cDelFg; font.pixelSize: 13; font.bold: true }
        ...
        // ---- BELOW THE TOOLBAR: side panel | main view (resizable) ----
        SplitView {
            Layout.fillWidth: true
                                ...
                                ColumnLayout {
                                    ...
                                    RowLayout {
                                        ...
                                        Rectangle {
                                            ...
                                            color: modelData.isFrom ? cAccent : cBtnBg
                                        ...
                                        Rectangle {
                                            visible: !modelData.working
                                            width: 18; height: 18; radius: 4
                                            color: modelData.isTo ? cAccent : cBtnBg
                                            border.width: 1; border.color: cBorder
                                            Text { anchors.centerIn: parent; text: "▶"; font.pixelSize: 9
                ...
                Rectangle {
                    ...
                    ColumnLayout {
                        ...
                        ListView {
                            ...
                            ScrollBar.vertical: ScrollBar {}
                            delegate: Rectangle {
                                // collapse hidden nodes to zero height
                                width: ListView.view.width
                                height: modelData.visible ? 24 : 0
                                ...
                                RowLayout {
                                    anchors.fill: parent
                                    anchors.leftMargin: 6 + modelData.depth * 14
                                    anchors.rightMargin: 8
                                    spacing: 5
                                    // disclosure arrow (folders only)
                                    Text {
                                        text: modelData.isDir ? (modelData.expanded ? "▾" : "▸") : ""
