...
impl Highlighter {
    ...
    /// Build a highlighter whose syntect theme tracks the desktop colour scheme:
    /// `InspiredGitHub` for light, `base16-ocean.dark` for dark.
    pub fn with_theme(dark: bool) -> Self {
